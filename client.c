        ...
        else
        {
		    ...
		    break;
                ...
                else if(strcmp(args[0],"send")==0)
                {
                    ...
                    send(sock , file_name, sizeof(args[1]),0);//send file name
                    ...
                    //file exits
                    FILE * file;
                    file=fopen(file_name,"w");//open a file for writing, if a file already exists then it will overwrite it
                    //printf("SFD");
                    while(1)
                    {
